...
const I18N = {
  zh: {
    brandName: '定制预制房',
    eyebrow: '供应链能力演示',
    heroTitle: '每次规格变了，几秒内就能看到渲染结果，并对照真实工厂参数校验——不用再走一轮邮件。',
    heroCta: '立即试用 ↓',
    ...
    specVerifiedDim: '最近核实时间：2026-07-15',
    ...
    specVerifiedCert: '最近核实时间：2026-07-15',
    specProd1: '标准批次交期：30–45 天，视订单量而定',
    specVerifiedProd: '最近核实时间：2026-07-15',
    examplesLabel: '示例输出',
    examplesHint: '由本引擎生成',
    featuredDiffLabel: '同一户型，改动一个参数',
    featuredBeforeTag: '改动前',
    featuredBeforeSpec: '2 间卧室 · 开放式厨房 · 客厅 · 卫浴',
    featuredAfterTag: '改动后 —— 卧室数量 2 → 3',
    featuredAfterSpec: '3 间卧室 · 开放式厨房 · 客厅 · 卫浴',
  ...
  en: {
    ...
    heroTitle: 'Every time your spec changes, see it rendered and checked against real factory constraints — in seconds, not a new round of emails.',
    heroCta: 'Try it live ↓',
    ...
    specVerifiedDim: 'Last verified: 2026-07-15',
    ...
    specVerifiedCert: 'Last verified: 2026-07-15',
    specProd1: 'Standard batch lead time: 30–45 days depending on order volume',
    specVerifiedProd: 'Last verified: 2026-07-15',
    ...
    featuredBeforeSpec: '2 bedrooms · open kitchen · living room · bathroom',
    featuredAfterTag: 'AFTER — bedroom count 2 → 3',
    featuredAfterSpec: '3 bedrooms · open kitchen · living room · bathroom',
...
// directly demonstrating "one spec change, engine keeps up."
// / "改动前/改动后"示例——用的是页面别处同一个 buildStep1Url()，两个都是真实
// 可打开的生成结果，不是截图或编造的图片。两份数据只有卧室数量不同。
// ---------------------------------------------------------------------
function renderFeaturedExample() {
  ...
  if (beforeLink) beforeLink.href = buildStep1Url([{ moduleId: 'bedroom-std', quantity: 2 }, ...baseModules], null);
  if (afterLink) afterLink.href = buildStep1Url([{ moduleId: 'bedroom-std', quantity: 3 }, ...baseModules], null);
}
